<template>
	<section>
		...
		<el-table :data="orderInformation" border highlight-current-row v-loading="listLoading" style="width: 100%;" id="table">
			...
			<el-table-column prop="orderStatus" label="充值手机号" width="120px;">
			</el-table-column>
			<el-table-column prop="creationTime" label="支付方式" width="110px;">
			</el-table-column>
			<el-table-column prop="deliveryTime" label="成本">
			</el-table-column>
			<el-table-column prop="deliveryTime" label="手续费6%" width="110px;">
			</el-table-column>
